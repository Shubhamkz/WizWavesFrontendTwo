...
const RecentsList = () => {
  ...
  return (
    <section className="grid grid-cols-12 px-6 gap-4">
      <div className="col-span-9 w-full">
        ...
        <div className="w-full md:max-h-[70vh] overflow-y-scroll custom-scrollbar">
      ...
      <div className="col-span-3  w-full rounded-2xl overflow-hidden   mt-12 h-max">
        <video
          width="600"
          ref={videoRef}
