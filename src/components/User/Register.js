...
const Register = () => {
  ...
  return (
    <div>
      <div className="flex justify-center items-center py-[4.1rem] bg-gradient-to-bl from-slate-900 via-slate-950 to-gray-800">
            ...
            <div className="max-w-md mx-auto text-white">
              <div className="flex flex-col justify-center items-center">
                <h1 className="bg-gradient-to-r from-blue-600 via-purple-500 to-indigo-400 inline-block text-transparent bg-clip-text font-extrabold text-3xl text-center">
                  Wizard<span className="text-white">Waves</span>
                </h1>
